...
let fruits = ['Banana', 'Apple', 'Melon', 'Mangosteen', 'Peach', 'Raspberry', 'Blueberry', 'Avocado', 'Grapes','Pomegranite','Tangerine', 'Mango', 'Cherry', 'Tomato',"avocado", "honey melon" ]
...
app.get('/recommend', (req, res) => {
  ...
  switch(type) {
    ...
    case 'vegetables':
      ...
      break;
      case 'keyboards':
        recommendation = 'Logitech MX Keyboard'
        break;
    default:
